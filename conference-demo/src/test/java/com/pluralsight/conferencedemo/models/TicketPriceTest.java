...
public class TicketPriceTest {
    ...
    public void testFind() throws Exception {
        TicketPrice ticket = repository.findById(1L).orElseThrow();
    ...
    public void testSaveAndGetAndDelete() throws Exception {
        ...
        TicketPrice otherTp = repository.findById(tp.getTicketPriceId()).orElseThrow();
    ...
    @Test void testNamedNativeQuery() throws Exception  {
